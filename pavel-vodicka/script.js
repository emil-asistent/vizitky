...
const TO_EMAIL = 'vodicka@money2u.cz';
...
form.addEventListener('submit', async e => {
  ...
  showNote(`Otevřel se váš e-mailový klient. Pokud ne, můžete mi napsat přímo na ${TO_EMAIL} nebo zavolat +420 723 248 314.`, 'success');
